export const StatesInCountry = {
  ...
  Algeria: [
    ...
    "Bordj Bou Arréridj", "Bouïra", "Boumerdès", "Chlef", "Djanet", "Djelfa",
    "El Bayadh", "El M’Ghair", "El Meniaa", "El Oued", "El Tarf", "Ghardaïa",
    "Guelma", "Illizi", "In Guezzam", "In Salah", "Jijel", "Khenchela",
    ...
    "Tiaret", "Timimoun", "Tindouf", "Tipasa", "Tissemsilt", "Tizi Ouzou",
    "Tlemcen", "Touggourt"
  ],
  Andorra: [
  ...
  Azerbaijan: [
    "Absheron", "Aghjabadi", "Agdam", "Agdash", "Agstafa", "Agsu", "Astara",
    "Babek", "Baku", "Balakan", "Barda", "Beylagan", "Bilasuvar", "Dashkasan",
    "Fizuli", "Gadabay", "Ganja", "Gobustan", "Goychay", "Goygol", "Hajigabul",
    "Imishli", "Ismailli", "Jabrayil", "Jalilabad", "Julfa", "Kalbajar",
    "Kangarli", "Khachmaz", "Khankendi", "Khizi", "Khojavend", "Kurdamir",
    "Lachin", "Lankaran", "Lerik", "Masalli", "Mingachevir", "Naftalan",
    "Nakhchivan", "Neftchala", "Oghuz", "Ordubad", "Qabala", "Qakh", "Qazakh",
    "Quba", "Qubadli", "Qusar", "Saatli", "Sabirabad", "Sadarak", "Salyan",
    "Samukh", "Shabran", "Shahbuz", "Shaki", "Shamakhi", "Shamkir", "Sharur",
    "Shirvan", "Siazan", "Sumqayit", "Tartar", "Tovuz", "Ujar", "Yardimli",
    "Yevlakh", "Zangilan", "Zardab"
  ],
  Bahamas: [
    "Acklins", "Berry Islands", "Bimini", "Black Point", "Cat Island",
    "Central Abaco", "Central Andros", "Central Eleuthera", "City of Freeport",
    "Crooked Island", "East Grand Bahama", "Exuma", "Grand Cay", "Harbour Island",
    "Hope Town", "Inagua", "Long Island", "Mangrove Cay", "Mayaguana",
    "Moore’s Island", "North Abaco", "North Andros", "North Eleuthera",
    "Ragged Island", "Rum Cay", "San Salvador", "South Abaco", "South Andros",
    "South Eleuthera", "Spanish Wells", "West Grand Bahama", "New Providence"
  ],
  Bahrain: [
  ...
  Belarus: [
    "Brest", "Gomel", "Grodno", "Mningarna", "Minsk", "Vitebsk", "Minsk City"
  ],
  Belgium: [
  ...
  Bulgaria: [
    ...
    "Sofia", "Sofia City", "Stara Zagora", "Targovishte", "Varna",
  ...
  Cabo_Verde: [
    ...
    "Ribeira Brava", "Ribeira Grande", "Ribeira Grande de Santiago", "Sal",
    "Santa Catarina", "Santa Catarina do Fogo", "Santa Cruz", "Santo Antão",
  ...
  Central_African_Republic: [
    "Bamingui-Bangoran", "Basse-Kotto", "Haut-Mbomou", "Haute-Kotto", "Kémo",
    "Lobaye", "Mambéré-Kadéï", "Mbomou", "Nana-Gribizi", "Nana-Mambéré",
  ...
  Croatia: [
    ...
    "Virovitica-Podravina", "Vukovar-Syrmia", "Zadar", "Zagreb", "Zagreb City"
  ],
  Cuba: [
  ...
  Czechia_Czech_Republic: [
    "Central Bohemian", "Hradec Králové", "Karlovy Vary", "Liberec",
    "Moravian-Silesian", "Olomouc", "Pardubice", "Plzeň", "Prague",
    "South Bohemian", "South Moravian", "Ústí nad Labem", "Vysočina", "Zlín"
  ],
  ...
  Denmark: [
    "Capital Region", "Central Denmark", "North Denmark", "South Denmark",
    "Zealand"
  ],
  Djibouti: [
  ...
  Finland: [
    "Åland Islands", "Central Finland", "Central Ostrobothnia", "Kainuu",
    "Kymenlaakso", "Lapland", "North Karelia", "Northern Ostrobothnia",
    "Northern Savonia", "Ostrobothnia", "Päijänne Tavastia", "Pirkanmaa",
    "Satakunta", "South Karelia", "Southern Ostrobothnia", "Southern Savonia",
  ...
  Iraq: [
    "Al Anbar", "Al Muthanna", "Al Qadisiyah", "An Najaf", "Arbil", "Babil",
    "Baghdad", "Basra", "Dhi Qar", "Diyala", "Dohuk", "Karbala", "Kirkuk",
    "Maysan", "Ninawa", "Salah ad Din", "Sulaymaniyah", "Wasit"
  ],
  Ireland: [
  ...
  Israel: [
    "Central District", "Haifa District", "Jerusalem District", "Judea and Samaria Area",
  ...
  Kazakhstan: [
    "Abai", "Akmola", "Aktobe", "Almaty", "Almaty City", "Astana", "Atyrau",
    "Baikonur", "East Kazakhstan", "Jambyl", "Jetisu", "Karaganda", "Kostanay",
    "Kyzylorda", "Mangystau", "North Kazakhstan", "Pavlodar", "Turkistan",
    "West Kazakhstan"
  ],
  Kenya: [
  ...
  Kyrgyzstan: [
    "Alai", "Batken", "Chuy", "Jalal-Abad", "Naryn", "Osh", "Talas", "Ysyk-Köl",
    "Bishkek", "Osh City"
  ],
  Laos: [
    "Attapeu", "Bokeo", "Bolikhamsai", "Champasak", "Houaphan", "Khammouane",
    "Luang Namtha", "Luang Prabang", "Oudomxay", "Phongsaly", "Sainyabuli",
    "Salavan", "Savannakhet", "Sekong", "Vientiane", "Vientiane Prefecture",
    "Xaisomboun", "Xiangkhouang"
  ],
  Latvia: [
    "Aizkraukle", "Alūksne", "Auce", "Baldone", "Balvi", "Bauska", "Cēsis",
    "Daugavpils", "Dobele", "Gulbene", "Jēkabpils", "Jelgava", "Krāslava",
    "Kuldīga", "Liepāja", "Limbaži", "Ludza", "Madona", "Ogre", "Preiļi",
    "Rēzekne", "Riga", "Saldus", "Talsi", "Tukums", "Valka", "Valmiera",
    "Ventspils", "Ādaži", "Ķekava", "Mārupe", "Olaine", "Ropaži", "Salaspils",
    "Saulkrasti", "Sigulda", "Smiltene", "Stopiņi", "Tērvete", "Varakļāni",
    "Viesīte", "Viļaka", "Viļāni"
  ],
  Lebanon: [
  ...
  Libya: [
    "Al Butnan", "Al Jabal al Akhdar", "Al Jabal al Gharbi", "Al Jufrah",
    "Al Kufrah", "Al Marj", "Al Wahat", "Benghazi", "Derna", "Ghat", "Misrata",
    "Murqub", "Murzuq", "Nalut", "Sabha", "Sirte", "Tripoli", "Wadi al Hayaa",
    "Wadi ash Shati", "Zawiya"
  ],
  Liechtenstein: [
  ...
  Madagascar: [
    ...
    "Atsinanana", "Atsimo-Andrefana", "Atsimo-Atsinanana", "Betsiboka", "Boeny",
    "Bongolava", "Diana", "Haute Matsiatra", "Ihorombe", "Itasy", "Melaky",
  ...
  Maldives: [
    ...
    "Lhaviyani", "Malé", "Meemu", "Noonu", "Raa", "Seenu", "Shaviyani", "Thaa",
    "Vaavu"
  ],
  Mali: [
  ...
  Malta: [
    ...
    "Mgarr", "Mosta", "Mqabba", "Msida", "Mtarfa", "Munxar", "Nadur", "Naxxar",
    "Paola", "Pembroke", "Pietà", "Qala", "Qormi", "Qrendi", "Rabat Gozo",
    "Rabat Malta", "Safi", "San Ġiljan", "San Ġwann", "San Lawrenz",
    "San Pawl il-Baħar", "Sannat", "Santa Luċija", "Santa Venera", "Senglea",
    "Siġġiewi", "Sliema", "Swieqi", "Ta' Xbiex", "Tarxien", "Valletta", "Xagħra",
    "Xewkija", "Żabbar", "Żebbuġ Gozo", "Żebbuġ Malta", "Żejtun", "Żurrieq"
  ],
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  Marshall_Islands: [
    "Ailinglaplap", "Ailuk", "Arno", "Aur", "Bikini", "Ebon", "Enewetak", "Jabat",
    "Jaluit", "Kili", "Kwajalein", "Lae", "Lib", "Likiep", "Majuro", "Maloelap",
    "Mejit", "Mili", "Namdrik", "Namu", "Rongelap", "Ujae", "Utrik", "Wotje"
  ],
  Mauritania: [
  ...
  Mauritius: [
    "Agaléga", "Black River", "Flacq", "Grand Port", "Moka", "Pamplemousses",
  ...
  Moldova: [
    "Anenii Noi", "Basarabeasca", "Bălți", "Bender", "Briceni", "Cahul",
    "Călărași", "Cantemir", "Căușeni", "Chișinău", "Cimișlia", "Criuleni",
    "Dondușeni", "Drochia", "Dubăsari", "Edineț", "Fălești", "Florești",
    "Găgăuzia", "Glodeni", "Hîncești", "Ialoveni", "Leova", "Nisporeni",
    "Ocnița", "Orhei", "Rezina", "Rîșcani", "Sîngerei", "Șoldănești", "Soroca",
    "Strășeni", "Ștefan Vodă", "Taraclia", "Telenești", "Transnistria", "Ungheni"
  ],
  Monaco: [],
  Mongolia: [
  ...
  Nauru: [
    "Aiwo", "Anabar", "Anibare", "Baitsi", "Boe", "Buada", "Denigomodu", "Ewa",
  ...
  Nicaragua: [
    ...
    "Río San Juan", "Rivas", "North Caribbean Coast", "South Caribbean Coast"
  ],
  Niger: [
  ...
  North_Macedonia: [
    "Berovo", "Bitola", "Bogdanci", "Bogovinje", "Bosilovo", "Brvenica", "Centar",
    "Centar Župa", "Čaška", "Češinovo-Obleševo", "Čučer-Sandevo", "Debar",
    "Debarca", "Delčevo", "Demir Hisar", "Demir Kapija", "Dolneni", "Gazi Baba",
    "Gevgelija", "Gostivar", "Gradsko", "Ilinden", "Jegunovce", "Karbinci",
    "Karpoš", "Kavadarci", "Kičevo", "Kisela Voda", "Kočani", "Konče", "Kratovo",
    "Kriva Palanka", "Krivogaštani", "Kruševo", "Kumanovo", "Lipkovo", "Lozovo",
    "Makedonska Kamenica", "Makedonski Brod", "Mavrovo and Rostuša", "Negotino",
    "Novaci", "Novo Selo", "Ohrid", "Petrovec", "Plasnica", "Prilep",
    "Probištip", "Radoviš", "Rankovce", "Resen", "Rosoman", "Saraj", "Sopište",
    "Star Dojran", "Staro Nagoričane", "Struga", "Strumica", "Studeničani",
    "Sveti Nikole", "Tearce", "Tetovo", "Valandovo", "Vasilevo", "Veles",
    "Vevčani", "Vinica", "Vrapčište", "Zelenikovo", "Zrnovci", "Štip",
    "Šuto Orizari"
  ],
  /////
  Norway: [
  ...
  Oman: [
    ...
    "Al Buraimi", "Al Wusta", "Dhofar", "Musandam", "Muscat",
  ...
  Panama: [
    ...
    "Guna Yala", "Ngäbe-Buglé", "Naso Tjër Di"
  ],
  Papua_New_Guinea: [
...
//   /////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Qatar: [
    "Ad Dawhah", "Al Khawr wa adh Dhakhirah", "Al Wakrah", "Ar Rayyan",
    "Ash Shamal", "Az Za'ayin", "Umm Salal", "Al-Shahaniya"
  ],
  Romania: [
    "Alba", "Arad", "Argeș", "Bacău", "Bihor", "Bistrița-Năsăud", "Botoșani",
    "Brașov", "Brăila", "Bucharest", "Buzău", "Caraș-Severin", "Călărași",
  ...
  Russia: [
    "Adygea", "Altai Krai", "Altai Republic", "Amur", "Arkhangelsk", "Astrakhan",
    "Bashkortostan", "Belgorod", "Bryansk", "Buryatia", "Chechnya", "Chelyabinsk",
    "Chukotka", "Chuvashia", "Crimea", "Dagestan", "Donetsk People's Republic",
    ...
    "Khanty-Mansi", "Kirov", "Komi", "Kostroma", "Krasnodar", "Krasnoyarsk",
    "Kurgan", "Kursk", "Leningrad", "Lipetsk", "Lugansk People's Republic",
    "Magadan", "Mari El", "Mordovia", "Moscow", "Moscow Oblast", "Murmansk",
    "Nenets", "Nizhny Novgorod", "Novgorod", "Novosibirsk", "Omsk", "Orenburg",
    "Oryol", "Penza", "Perm", "Primorsky", "Pskov", "Rostov", "Ryazan", "Sakha",
    "Sakhalin", "Samara", "Saratov", "Smolensk", "Stavropol", "Sverdlovsk",
    "Tambov", "Tatarstan", "Tomsk", "Tula", "Tver", "Tyumen", "Udmurtia",
    "Ulyanovsk", "Vladimir", "Volgograd", "Vologda", "Voronezh", "Yaroslavl",
    "Zabaykalsky"
  ],
  Rwanda: [
  ...
  Saint_Kitts: [
    ...
    "Saint George Basseterre", "Saint John Capisterre", "Saint Mary Cayon",
    "Saint Paul Capisterre", "Saint Peter Basseterre",
  ...
  Saint_Vincent: [
    "Charlotte", "Northern Grenadines", "Southern Grenadines", "Saint Andrew",
  ...
  Principe: [
    "Caué", "Lembá", "Lobata", "Mé-Zóchi", "Pagué", "Santo António"
  ],
  Saudi_Arabia: [
    "Al Bahah", "Al Jawf", "Al Madinah", "Al Qassim", "Ar Riyad", "Asir",
    "Eastern Province", "Ha'il", "Jazan", "Makkah", "Najran", "Northern Borders",
    "Tabuk"
  ],
  Senegal: [
  ...
  Serbia: [
    "Belgrade", "Bor", "Braničevo", "Central Banat", "Danube", "Jablanica",
    "Kolubara", "Mačva", "Moravica", "Nišava", "North Bačka", "North Banat",
    "Pčinja", "Pirot", "Podunavlje", "Pomoravlje", "Rasina", "Raška",
  ...
  Seychelles: [
    ...
    "La Digue and Inner Islands", "Les Mamelles", "Mont Buxton", "Mont Fleuri",
    "Plaisance", "Pointe La Rue", "Port Glaud", "Roche Caiman", "Saint Louis",
    "Takamaka", "Outer Islands"
  ],
  Sierra_Leone: [
...
Slovenia: [
  ...
  "Bohinj", "Borovnica", "Bovec", "Braslovče", "Brda", "Brezovica", "Brežice",
  "Cankova", "Celje", "Cerklje na Gorenjskem", "Cerknica", "Cerkno",
  "Cerkvenjak", "Črenšovci", "Črna na Koroškem", "Črnomelj", "Destrnik",
  "Divača", "Dobje", "Dobrepolje", "Dobrova-Polhov Gradec", "Dobrovnik",
  "Dol pri Ljubljani", "Dolenjske Toplice", "Domžale", "Dornava", "Dravograd",
  "Duplek", "Gorenja Vas-Poljane", "Gorišnica", "Gorje", "Gornja Radgona",
  "Gornji Grad", "Gornji Petrovci", "Grad", "Grosuplje", "Hajdina",
  "Hoče-Slivnica", "Hodoš", "Horjul", "Hrastnik", "Hrpelje-Kozina", "Idrija",
  "Ig", "Ilirska Bistrica", "Ivančna Gorica", "Izola", "Jesenice", "Jezersko",
  "Juršinci", "Kamnik", "Kanal", "Kidričevo", "Kobarid", "Kobilje", "Kočevje",
  "Komen", "Komenda", "Kostel", "Kozje", "Kranj", "Kranjska Gora", "Križevci",
  "Krško", "Kungota", "Kuzma", "Laško", "Lenart", "Lendava", "Litija",
  "Ljubljana", "Ljubno", "Ljutomer", "Logatec", "Loška Dolina", "Loški Potok",
  "Lovrenc na Pohorju", "Luče", "Lukovica", "Majšperk", "Maribor", "Markovci",
  "Medvode", "Mengeš", "Metlika", "Mežica", "Miklavž na Dravskem Polju",
  "Miren-Kostanjevica", "Mirna", "Mirna Peč", "Mislinja", "Mokronog-Trebelno",
  "Moravče", "Moravske Toplice", "Mozirje", "Murska Sobota", "Muta",
  "Naklo", "Nazarje", "Nova Gorica", "Novo Mesto", "Odranci", "Oplotnica",
  "Ormož", "Osilnica", "Pesnica", "Piran", "Pivka", "Podčetrtek", "Podlehnik",
  "Podvelka", "Polzela", "Postojna", "Prebold", "Preddvor", "Prevalje",
  "Ptuj", "Puconci", "Rače-Fram", "Radeče", "Radenci", "Radlje ob Dravi",
  "Radovljica", "Ravne na Koroškem", "Razkrižje", "Ribnica", "Ribnica na Pohorju",
  "Rogaška Slatina", "Rogašovci", "Rogatec", "Ruše", "Selnica ob Dravi",
  "Semič", "Sevnica", "Sežana", "Slovenj Gradec", "Slovenska Bistrica",
  "Slovenske Konjice", "Starše", "Straža", "Sveta Ana", "Sveta Trojica v Slovenskih Goricah",
  "Sveti Andraž v Slovenskih Goricah", "Sveti Jurij ob Ščavnici",
  "Sveti Jurij v Slovenskih Goricah", "Sveti Tomaž", "Šalovci", "Šempeter-Vrtojba",
  "Šenčur", "Šentilj", "Šentjernej", "Šentjur", "Škocjan", "Škofja Loka",
  "Škofljica", "Šmarje pri Jelšah", "Šmarjeske Toplice", "Šmartno ob Paki",
  "Šmartno pri Litiji", "Šoštanj", "Štore", "Tabor", "Tišina", "Tolmin",
  "Trbovlje", "Trebnje", "Trnovska Vas", "Trzin", "Tržič", "Turnišče",
  "Velenje", "Velika Polana", "Velike Lašče", "Veržej", "Videm", "Vipava",
  "Vitanje", "Vodice", "Vojnik", "Vrhnika", "Vuzenica", "Zagorje ob Savi",
  "Zavrč", "Zeleniki", "Žalec", "Železniki", "Žiri", "Žirovnica", "Žužemberk"
],
Solomon_Islands: [
...
South_Korea: [
  ...
  "Chungbuk", "Chungnam", "Gyeongbuk", "Gyeongnam", "Sejong"
],
South_Sudan: [
...
Spain: [
  ...
  "La Rioja", "Navarre", "Region of Murcia", "Valencian Community",
  "Ceuta", "Melilla"
],
Sri_Lanka: [
...
Sudan: [
  "Al Jazirah", "Blue Nile", "Central Darfur", "East Darfur", "Gedaref",
...
Syria: [
  "Al-Hasakah", "Aleppo", "As-Suwayda", "Damascus", "Daraa", "Deir ez-Zor",
  "Hama", "Homs", "Idlib", "Latakia", "Quneitra", "Raqqa", "Rif Dimashq",
  "Tartus"
],
Taiwan: [
  "Changhua", "Chiayi", "Chiayi City", "Hsinchu", "Hsinchu City",
  "Hualien", "Kaohsiung", "Keelung", "Kinmen", "Lienchiang",
  "Miaoli", "Nantou", "New Taipei", "Penghu", "Pingtung", "Taichung",
...
Thailand: [
  ...
  "Nong Khai", "Nonthaburi", "Pathum Thani", "Pattani", "Phangnga",
...
Timor_Leste: [
  ...
  "Ermera", "Lautém", "Liquiçá", "Manatuto", "Manufahi",
  "Oecusse", "Viqueque"
],
Togo: [
...
Tonga: [
  "ʻEua", "Haʻapai", "Niuas", "Tongatapu", "Vavaʻu"
],
Trinidad: [
  "Arima", "Chaguanas", "Couva-Tabaquite-Talparo", "Diego Martin",
  "Mayaro-Rio Claro", "Penal-Debe", "Point Fortin", "Port of Spain",
  "Princes Town", "San Fernando", "Sangre Grande", "Siparia",
  "Tunapuna-Piarco"
],
Tobago: [
  "Eastern Tobago", "Western Tobago"
],
Tunisia: [
...
Turkmenistan: [
  "Ahal", "Balkan", "Daşoguz", "Lebap", "Mary", "Ashgabat"
],
Tuvalu: [
...
Uganda: [
  ...
  "Bugweri", "Buhweju", "Buikwe", "Bukedea", "Bukomansimbi",
  "Bukwo", "Bulambuli", "Buliisa", "Bundibugyo", "Bunyangabu",
  "Bushenyi", "Busia", "Butaleja", "Butambala", "Butebo",
  "Buvuma", "Buyende", "Dokolo", "Gomba", "Gulu", "Hoima",
  "Ibanda", "Iganga", "Isingiro", "Jinja", "Kaabong", "Kabale",
  "Kabarole", "Kaberamaido", "Kagadi", "Kakumiro", "Kalangala",
  "Kaliro", "Kalungu", "Kampala", "Kamuli", "Kamwenge",
  "Kanungu", "Kapchorwa", "Kapelebyong", "Karenga", "Kasese",
  "Katakwi", "Kayunga", "Kibale", "Kiboga", "Kibuku", "Kikuube",
  "Kiruhura", "Kiryandongo", "Kisoro", "Kitagwenda", "Kitgum",
  "Koboko", "Kole", "Kotido", "Kumi", "Kwania", "Kween",
  "Kyankwanzi", "Kyegegwa", "Kyotera", "Lamwo", "Lira", "Luuka",
  ...
  "Namayingo", "Namisindwa", "Namutumba", "Napak", "Nebbi",
  "Ngora", "Ntoroko", "Ntungamo", "Nwoya", "Obongi", "Omoro",
  "Otuke", "Oyam", "Pader", "Pakwach", "Pallisa", "Rakai",
  "Rubanda", "Rubirizi", "Rukiga", "Rukungiri", "Rwampara",
...
Ukraine: [
  ...
  "Kyiv", "Kyiv City", "Kirovohrad", "Luhansk", "Lviv", "Mykolaiv",
...
Yemen: [
  ...
  "Hajjah", "Ibb", "Lahij", "Ma'rib", "Raymah", "Sa'dah",
  "Sana'a", "Shabwah", "Socotra", "Ta'izz"
],
Zambia: [
